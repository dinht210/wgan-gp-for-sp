...
generator = Generator(input_size=59)  # Adjust n_features as needed
generator.load_state_dict(torch.load("models/wgan-gps/financial_1y_generator.pth"))
generator.eval()

x_scaler = joblib.load("models/scalers/financial_1y_x_scaler.pkl")
y_scaler = joblib.load("models/scalers/financial_1y_y_scaler.pkl")
one_hot_encoder = joblib.load("models/encoders/financial_1y_one_hot_encoder.pkl")
